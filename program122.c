//Develop a C program that dynamically allocates memory for an array based on user input, accepts array elements from the user, prints the array, calculates the sum of its elements using a dedicated function, and then frees the allocated memory.
#include<stdio.h>
#include<stdlib.h>
