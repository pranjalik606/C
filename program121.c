//Write a C program that dynamically allocates memory for an array based on user input, accepts array elements from the user, prints the array, and then passes the array to a function for processing.
